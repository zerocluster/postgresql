...
export default class Pgsql extends Events {
    ...
    get isPrimary () {
        return this.#app.components.service === "default";
    }

    get isSyncStandby () {
        return this.#app.components.service === "standby";
    }
    ...
    async #initPrimary () {
        ...
        this.#writePostgresConfig( {
            "synchronous_standby_names": `FIRST 2 ( s1, s2 )`,
        } );
    ...
    async #initStandby () {
        ...
        // write postgres config
        this.#writePostgresConfig( {
            "cluster_name": this.process.cli.options.standbyName,
        } );
...
` );
    ...
    #writePostgresConfig ( additionalConfig ) {
        ...
        // merge configs
        const config = mergeObjects( {}, this.config.settings, additionalConfig );
